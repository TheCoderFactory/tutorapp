...
class EnquiriesControllerTest < ActionController::TestCase
  ...
  test "should create enquiry" do
    assert_difference('Enquiry.count') do
      post :create, enquiry: { body: @enquiry.body, email: @enquiry.email, name: @enquiry.name, phone: @enquiry.phone, user_id: @enquiry.user_id }
    end
  ...
  test "should update enquiry" do
    patch :update, id: @enquiry, enquiry: { body: @enquiry.body, email: @enquiry.email, name: @enquiry.name, phone: @enquiry.phone, user_id: @enquiry.user_id }
    assert_redirected_to enquiry_path(assigns(:enquiry))
  end
